...
model_path = "/work/XRAYDIFF/eitahtnk/zero123-165000"
...
path = "###_20160628_HAND__1（小）"
# log_dir = f"outputs/xray123_test_out/{path}/{step}"
log_dir = f"/work/XRAYDIFF/eitahtnk/zero123-hf/inference/generated_image/originalzero123/{path}/{step}"
